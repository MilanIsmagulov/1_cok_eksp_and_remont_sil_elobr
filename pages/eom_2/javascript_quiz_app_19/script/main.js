...
let mainQuestions = [
    {
        text: 'С какой целью осуществляется дефектация при ремонте электродвигателя:',
        right: [0],
        type: 1,
        points: 100,
        answers: ['для определения объема и стоимости ремонта', 'для определения объема и характера ремонта', 'для определения объема послеремонтных испытаний', ],
    },
];
