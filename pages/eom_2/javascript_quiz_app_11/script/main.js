...
let mainQuestions = [
    {
        text: 'Для обмоток статора асинхронного электродвигателя напряжением до 660 В сопротивление изоляции должно быть не менее:',
        right: [2,],
        type: 1,
        points: 100,
        answers: ['0,5 МОм при температуре 10-30<sup>0</sup>С и не менее 1,0 МОм при температуре 60<sup>0</sup>С', '1 МОм при температуре 10-30<sup>0</sup>С и не менее 1,5 МОм при температуре 60<sup>0</sup>С', '1 МОм при температуре 10-30<sup>0</sup>С и не менее 0,5 МОм при температуре 60<sup>0</sup>С', ],
    },
];
