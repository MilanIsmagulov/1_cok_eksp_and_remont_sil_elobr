...
// let 
const anwserArr = ['Отключить автоматический  выключатель', 'Вывесить плакат «Не включать! Работают люди»', 'Проверить отсутствие напряжения', 'Отсоединить питающий кабель', 'Принять меры, препятствующие вращению электродвигателя  со стороны рабочего механизма', 'Установить защитное заземление', ];
...
let questionPlace = 'Установите очередность операций  при выводе в ремонт электродвигателя:';
