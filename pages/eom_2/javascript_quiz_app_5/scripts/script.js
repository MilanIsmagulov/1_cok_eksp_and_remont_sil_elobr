...
// let 
const anwserArr = ['На «холодный» автомат подают ток 3,5 или 10 А', 'Автомат должен отключиться за  0,1 секунды или более', 'Автомат должен установиться в «холодное» состояние', 'На автомат подают ток 5, 10 или 20 А', 'Автомат должен отключиться менее, чем за 0,1 секунды',];
...
let questionPlace = 'Установите очередность  операций при проверке электромагнитного расцепителя автоматического выключателя.';
