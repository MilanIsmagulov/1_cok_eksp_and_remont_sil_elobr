...
let mainQuestions = [
    {
        text: 'Прибором какого типа выполняется измерение сопротивления изоляции кабеля:',
        right: [0,],
        type: 1,
        points: 100,
        answers: ['мегаомметром  электронного и механического типа', 'мегаомметром  механического типа', 'мегаомметром  электронного типа', ],
    },
];
